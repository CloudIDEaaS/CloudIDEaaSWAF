...
#Region "Variables"
    ...
    Public Property GrammarEdits As New List(Of GrammarEdit)
    Friend Property LockObject As IManagedLockObject
...
#Region "New"
    Public Sub New(ByRef NHunspellObject As Hunspell)
        ...
        GrammarEdits = New List(Of GrammarEdit)
...
#Region "Spelling Functions and Subs"
    ...
    Public Function HasGrammarErrors() As Boolean
    ...
    Public Function IsPartOfSpellingError(ByVal CharIndex As Integer) As Boolean
        ...
        If _spellingErrorRanges Is Nothing Then
            Return False
        End If
    ...
    Public Function IsPartOfGrammarError(ByVal CharIndex As Integer) As Boolean

        For Each grammarEdit In GrammarEdits

            If CharIndex.IsBetween(grammarEdit.StartGrammar, grammarEdit.EndGrammar) Then
                Return True
            End If
