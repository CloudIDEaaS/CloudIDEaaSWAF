...
using Pipeline = System.Management.Automation.Runspaces.Pipeline;
using Utils.Wrappers.Interfaces;
using Task = System.Threading.Tasks.Task;

namespace Hydra.StartupTests
{
    [Flags]
    public enum MockTypes
    {
        ...
        DevOpsDBContext = 1 << 2,
        SessionService = 1 << 3,
        DevOpsControllerOnly = 1 << 4,
        CreateSession = 1 << 5,
        RunspaceFactory = 1 << 6,
        ClientServerDatabase = CreateSession | DevOpsClient | DevOpsDBContext | SessionService,
        DevOpsControllerWithSessions = CreateSession | ClientServerDatabase | DevOpsControllerOnly
    }

    public static partial class TestHelpers
    {
        public static Mocks SetupMocks(dynamic appSettings, IServiceProvider serviceProvider, MockTypes mockTypes)
        {
