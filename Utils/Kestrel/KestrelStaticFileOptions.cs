...
/// </summary>
public class KestrelStaticFileOptions : KestrelSharedOptionsBase
{
    internal static readonly Func<KestrelStaticFileResponseContext, bool> defaultOnPrepareResponse = _ => false;
    internal static readonly Func<KestrelStaticFileResponseContext, Task> defaultOnPrepareResponseAsync = _ => Task.CompletedTask;

    /// <summary>
    /// Defaults to all request paths
    /// </summary>
    public KestrelStaticFileOptions() : this(new SharedOptions())
    {
    }
    ...
    public KestrelStaticFileOptions(SharedOptions sharedOptions) : base(sharedOptions)
    {
        OnPrepareResponse = defaultOnPrepareResponse;
        OnPrepareResponseAsync = defaultOnPrepareResponseAsync;
    }
    ...
    /// </remarks>
    public Func<KestrelStaticFileResponseContext, bool> OnPrepareResponse { get; set; }
    ...
    /// <see cref="OnPrepareResponse" /> is called before <see cref="OnPrepareResponseAsync" />.
    /// </remarks>
    public Func<KestrelStaticFileResponseContext, Task> OnPrepareResponseAsync { get; set; }
}