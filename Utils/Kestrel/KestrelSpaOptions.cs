...
/// </summary>
public class KestrelSpaOptions : IOptions<StaticFileOptions>
{
    ...
    internal KestrelSpaOptions(KestrelSpaOptions copyFromOptions)
    {
    ...
    /// </summary>
    public KestrelStaticFileOptions? DefaultPageStaticFileOptions { get; set; }
    ...
    public StaticFileOptions Value { get; internal set; }
